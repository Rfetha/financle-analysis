...
| **M2** | Deep analiz (UC1) **+ Big Players**: Alpaca fiyat · EDGAR fundamentals/13F/Form4 · FRED makro · teknikler(elle) · news · peers + DeepAnalysis recipe + grafik + `/api/stream/quotes` SSE | **A:** "NVDA" → top-down rapor + Lightweight Chart · **B:** "NVDA'yı kim aldı" → filer + Δ | ~24 | 🔄 **Faz A ✅** / Faz B ⏳³ | [spec](superpowers/specs/2026-07-13-m2-deep-analysis-and-big-players-design.md) · [plan](superpowers/plans/2026-07-13-m2-deep-analysis-and-big-players.md) |
